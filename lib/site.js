...
export const site = {
  ...
  // URL produksi final (untuk Open Graph & sitemap).
  url: "https://desa-gunung-anyar.vercel.app",
  ...
  // Koordinat pusat desa (dipakai peta) — titik Kantor/Balai Desa Gunung Anyar.
  koordinat: { lat: -7.88560420109162, lng: 113.921614194951 },

  // Kontak kantor desa
  kontak: {
    alamat: "4W7C+PJX, Kokebun, Gn. Anyar, Tapen, Kabupaten Bondowoso, Jawa Timur 68283",
    telepon: "+62 822-3211-1323",
    whatsapp: "6282232111323", // format internasional tanpa "+"
    email: "gununganyar090@gmail.com",
    jamPelayanan: "Senin–Jumat, 08.00–15.00 WIB",
  },

  sosial: {
    instagram: "https://www.instagram.com/desagununganyar.official",
    facebook: "https://web.facebook.com/people/Desa-Gunung-Anyar/61591679034822/",
...
export const kategoriLokasi = [
  ...
  { key: "pendidikan", label: "Pendidikan", warna: "#185fa5", icon: "school" },
  { key: "ibadah", label: "Tempat Ibadah", warna: "#0f6e56", icon: "building-mosque" },
  { key: "olahraga", label: "Olahraga & Ruang Publik", warna: "#534ab7", icon: "ball-football" },
  { key: "layanan", label: "Pemerintahan & Kesehatan", warna: "#3b6d11", icon: "building-community" },
];
