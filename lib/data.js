...
/*
  Path versi kecil sebuah foto: "/images/lokasi/a.jpg" -> "/images/lokasi/a-thumb.jpg".
  Dipakai untuk kartu & grid supaya tidak mengunduh foto ukuran penuh.
  File -thumb dihasilkan sekali saat foto ditambahkan; kalau kebetulan belum
  ada, <SmartImage> otomatis memakai foto penuh sehingga tampilan tetap aman.
*/
export function fotoKecil(src) {
  if (!src) return undefined;
  return src.replace(/\.(jpe?g|png|webp)$/i, "-thumb.jpg");
}
